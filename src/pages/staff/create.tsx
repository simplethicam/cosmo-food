...
import { IStaff, IFile, IStore, Nullable } from "../../interfaces";
import { StaffImageUpload } from "../../components/staff";
...
export const StaffCreate = () => {
  ...
  const stepsForm = useStepsForm<IStaff, HttpError, Nullable<IStaff>>({
    stepsProps: {
  ...
  return (
    ...
    >
      <DialogTitle sx={{ m: 0, p: 2 }}>{t("staff.actions.add")}</DialogTitle>
      <IconButton
            color="error"
        aria-label="close"
...
type UseStepsFormList = {
  stepsForm: UseStepsFormReturnType<IStaff, HttpError, Nullable<IStaff>>;
};
...
const useStepsFormList = ({ stepsForm }: UseStepsFormList) => {
          ...
          render={({ field }) => {
            return (
              <TextField
                ...
                label={t("staff.fields.name.label")}
                placeholder={t("staff.fields.name.label")}
              />
            );
          }}
        />
          ...
          render={({ field }) => {
            return (
              <TextField
                ...
                placeholder={t("staff.fields.email.label")}
              />
            );
          }}
        />
              ...
              >
                ...
                {(props: TextFieldProps) => (
                  <TextField
                    ...
                    variant="outlined"
                    id="gsm"
                    label={t("staff.fields.gsm.label")}
                    placeholder={t("staff.fields.gsm.label")}
                  />
                )}
              </InputMask>
            );
          ...
          render={({ field }) => {
            return (
              <TextField
                ...
                placeholder={t("staff.fields.address.label")}
              />
            );
          }}
        />
          ...
          render={({ field }) => (
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={t("staff.fields.store.label")}
                  variant="outlined"
                  error={!!errors.store}
                  required
                />
          ...
          render={({ field }) => {
            return (
              <TextField
                ...
                required
                variant="outlined"
                label={t("staff.fields.accountNumber.label")}
                placeholder={t("staff.fields.accountNumber.label")}
              />
            );
          }}
        />
          ...
          render={({ field }) => (
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={t("staff.fields.vehicle.label")}
                  variant="outlined"
          ...
          render={({ field }) => {
            return (
              <TextField
                ...
                required
                variant="outlined"
                label={t("staff.fields.licensePlate.label")}
                placeholder={t("staff.fields.licensePlate.label")}
              />
            );
          }}
        />
  ...
  const stepTitles = [
    t("staff.steps.personal"),
    t("staff.steps.company"),
    t("staff.steps.vehicle"),
  ];
